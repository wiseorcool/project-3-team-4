...
#     # Create a Plotly figure
#     # fig = px.bar(df, x='name', y='percentage', title='Percentage Distribution of Movie Genres',
#     #              labels={'name': 'Genre', 'percentage': 'Percentage (%)'})
    

#     fig = px.icicle(df, path=[ px.Constant('Genres'),'name', 'percentage'], values='percentage',
#                   color='percentage', hover_data=['name'])
#     fig.show()
